"""
Django settings for yayos_barber project.
...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'yayos-barber.onrender.com']
...
INSTALLED_APPS = [
    'yayos_barber',  # Tu aplicación de gestión de citas
...
>>>>>>> 35290fcfeefc588636396d94a8521683aef3d10c
}
